...
class Index {
    ...
    public void index() {
        ...
        try {
            ...
            //要搜索的File路径
            File dFile = new File("e:/LuceneDemo/data");
            /*;
             * 
    ...
    public void getFile(File file,IndexWriter indexWriter){
    	try {
        ...
        try {  
            ...
            for (ScoreDoc scoreDoc : scoreDocs) {  
                ...
                System.out.println(filename + " " + filepath);
	           	...
	           	String highTitle = highlighter.getBestFragment(analyzer, filename,keyWord);
	           	String highContent= highlighter.getBestFragment(analyzer, filepath,keyWord);
